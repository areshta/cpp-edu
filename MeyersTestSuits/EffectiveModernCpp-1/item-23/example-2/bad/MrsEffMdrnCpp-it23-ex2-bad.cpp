...
public: 
    ...
    explicit WrongMoving( const SpecSniffer sf):
        m_sf(move(sf)) // error: const type impossible to move. Copy constructor will be called!
    {
    }
private:
    SpecSniffer m_sf;
...
int32_t main()
{
    ...
    cout << "\n\nWrong moving example: " << endl;

    WrongMoving wm1;
    WrongMoving wm2(wm1); // With move() is working... nice question for investigation
